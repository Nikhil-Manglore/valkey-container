## THIS FILE IS AUTO-GENERATED BY THE [Valkey-Release-Automation](https://github.com/Nikhil-Manglore/valkey-release-automation/blob/main/.github/workflows/update-docker.yml) REPOSITORY
